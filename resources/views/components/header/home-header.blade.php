            ...
            <div class="navigation-bar">
                ...
                <form action="{{ route('frontend.adlist.search') }}" method="GET">
                    <div class="navigation-bar__search-field">
                        <input type="text" placeholder="{{ __('ads_title_keyword') }}..." name="keyword"  required />
                ...
                <div class="navigation-bar__buttons">
                    @if (auth('user')->check())
                        ...
                        <div class="navigation_icon d-none d-sm-block">
                            <a href="{{ route('frontend.favourites') }}" title="Favourites List">
                            ...
                            <a href="{{ route('frontend.message') }}" title="Chat History">
                                ...
                                <span id="unread_count_custom3"
                                    class="text-danger unread-message-img "
                    ...
                    @else
                        ...
                        <a href="{{ route('users.login') }}" class="ms-3 btn login_required post-ads">
                            <!-- <span class="icon--left">
                                <x-svg.image-select-icon />
                            </span> -->
                            {{ __('post_ads') }}
