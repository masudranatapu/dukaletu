        ...
        <div class="dashboard-post__ads step-information">
            ...
            <form id="step2_edit_form" action="{{ route('frontend.post.step2.update', $ad->slug) }}" method="POST"
                            ...
                            {{-- <div class="input-field__group">
                                ...
                                <div class="input-field">
                                    ...
                                    <input name="location[place]" id="" type="text" class="backupPhone"
                                        placeholder=""
                                        value="{{ Session::has('location') ? Session::get('location')['place'] : $ad->place }}"
                                        required />
                                </div>
                                        ...
                                        @isset($countries)
                                            @foreach ($countries as $country)
                                                <option value="{{ $country->id }}"
                                                    @if ($ad->country == $country->id) selected @endif>{{ $country->location }}
                                                </option>
                                            @endforeach
                                        @endisset
                ...
                <div class="dashboard-post__action-btns">
                    <a href="{{ route('frontend.post.step1.back', $ad->slug) }}"
                        class="btn btn--lg btn--outline text-white">
                        {{ __('previous') }}
                    </a>
